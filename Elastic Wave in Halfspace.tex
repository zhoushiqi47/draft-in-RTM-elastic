...
+O(\frac{y_2}{|x-y|}\frac{1}{(k_s|x-y|)^{3/4}}+\frac{|x_1-y_1|}{|x-y|}\frac{1}{(k_s|x-y|)^{5/4}})
\ee
\be
\hspace{-2.5cm} \nn
...
+O(\frac{k_s z_2}{|x-z|}\frac{1}{(k_s|x-z|)^{3/4}}+\frac{k_s|x_1-z_1|}{|x-z|}\frac{1}{(k_s|x-z|)^{5/4}})
\ee
...
\be
F_d(z,y)= =\frac{\i}{2\pi}\int_{\theta^1_d}^{\theta^2_d}e^{\i k_s(z_1-y_1)\cos\theta+\i k_s(z_2-y_2\sin\theta)}
\ee
where $0<\theta^1_d<\pi/2<\theta^2_d<\pi$ and $z_2=(d+y_1)\tan \theta^1_d=(y_1-d)\tan \theta^2_d$.
\end{lem}
