...
\begin{lem}\label{es_dgreen2}
	For every $x\in\Gamma_0$, $y\in\R_+^2$ that $|x_1-y_1|/|x-y|>(1+\kappa)/2$ and $y_2/|x-y|<\kappa/2$, we have
	\be
...
\begin{thm} \label{ap_psf}
	...
	\be \hspace{-2cm}
	|J(z,y)-J_d(z,y)|+k_s^{-1}|\nabla_y(J(z,y)-J_d(z,y))|\leq C (\frac{h}{\mu d}+\frac{(k_s h)^{1/2}}{\mu e^{\sqrt{k_r^2-k_s^2}h}})(\frac{h}{d})^{1/2}
	\ee
	where the constant C is only dependent on $\kappa$.
\end{thm}
\debproof
...
\frac{1}{|x-y|^{1/2}}+e^{-\sqrt{k_r^2-k_s^2}y_2}\bigg)\\
\leq
\frac{C}{\mu}\int_{(1-c_1)d/h}^{\infty}\frac{1}{1+t^2}+\frac{(k_s h)^{1/2}}{(1+t^2)^{3/4}} e^{-\sqrt{k_r^2-k_s^2}h} \\
\leq C (\frac{h}{\mu d}+\frac{(k_s h)^{1/2}}{\mu e^{\sqrt{k_r^2-k_s^2}h}})(\frac{h}{d})^{1/2}
\een
