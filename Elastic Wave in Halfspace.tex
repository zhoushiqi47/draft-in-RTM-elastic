...
\begin{lem}
For any $z,y\in \R^2_+$, $J_d(z,y)=F_d(z,y)+O(\frac{1}{(k_s h)^{1/4}})$, where
\be
F_d(z,y)= =\frac{\i}{2\pi}\int_{\theta^d_1}^{\theta^d_1}e^{\i k_s(z_1-y_1)\cos\theta+\i k_s(z_2-y_2\sin\theta)}
\ee
where $0<\theta^d_1<\pi/2<\theta^d_2<\pi$ and $z_2=(d+y_1)\tan \theta^d_1=(y_1-d)\tan \theta^d_2$.
\end{lem}
\debproof
\ben
\frac{y_2}{|x-y|}\frac{1}{(k_s|x-y|)^{3/4}}+\frac{|x_1-y_1|}{|x-y|}\frac{1}{(k_s|x-y|)^{5/4}} \\ \hspace{-0.5cm}
=(\frac{k_s z_2}{|x-z|}\frac{1}{(k_s|x-z|)^{3/4}}+\frac{k_s|x_1-z_1|}{|x-z|}\frac{1}{(k_s|x-z|)^{5/4}})(1+O(\frac{|y-z|}{|x-z|}))
\een
\ben
|\mu_\i(k_j\frac{x_1-y_1}{|x-y|})-\mu_\i(k_j\frac{x_1-z_1}{|x-z|})| \\  \leq 
Ck_j \sqrt{\Big|\frac{x_1-y_1}{|x-y|}-\frac{x_1-z_1}{|x-z|}\Big|} \leq C k_j \Big(\frac{|y-z|}{|x-z|}\Big)^{1/2}
\een
where $i,j=s,p$.
\be \label{G_prin}\hspace{-2cm}
\mathcal{G}_s(x,y)=\mathcal{G}_s(x,z)e^{\i k_s\widehat{x-z}\cdot (z-y)}(1+O(\frac{k_s|y-z|^2}{|x-z|}))+O(\Big(\frac{|y-z|}{k_s|x-z|^2}\Big)^{1/2}) \\ \hspace{-2cm}
\mathcal{G}_p(x,y)=\mathcal{G}_p(x,z)e^{\i k_p\widehat{x-z}\cdot (z-y)}(1+O(\frac{k_p|y-z|^2}{|x-z|}))+O(\Big(\frac{|y-z|}{k_p|x-z|^2}\Big)^{1/2}) 
\ee
By substituting (\ref{G_prin}) into $J_d(z,y)$, we have
\finproof
